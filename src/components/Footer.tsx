          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">+351913709717</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-5 w-5 text-blue-400" />
                <span className="text-gray-400">umpulsiva@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-5 w-5 text-blue-400" />
                <span className="text-gray-400">Avenida Almirante Reis 102, 1150-022 Lisboa, Portugal(Avenida Almirante Reis 102, 1150-022 Lisboa, Portugal)</span>
              </div>
            </div>
          </div>
        </div>
